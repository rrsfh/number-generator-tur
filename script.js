...
function submitNumber() {
  ...
  const scriptURL = 'https://script.google.com/macros/s/AKfycbyK7Knsi2wzAyDfLJ3CQr8c3nYSW1jWdMRyzGtx7y_Hk_AZGVz4Rq6qsK6OhxydobSh/exec'
...
function goToLink() {
  if (completionToken) {
    ...
    alert('Tamamlama belirteci eksik!');
  }
}
...
function showAlert(tabName) {
  ...
  switch (tabName) {
    case 'Home':
      message = "Sayı Üretecine Hoş Geldiniz. Lütfen çalışmamızın bir sonraki aşamasına geçmek için ekrandaki talimatları izleyin.";
      break;
    case 'Instructions':
      message = "Talimatlar: Deneyinizde kullanmak üzere bir sayı oluşturun. Bu sayıyı daha sonra ihtiyaç duyacağınız için mutlaka hatırlayın.";
      break;
    case 'Contact':
      message = "Bu sayfada takılırsanız, lütfen BeSample üzerinden bizimle iletişime geçin; size mümkün olan en hızlı şekilde yardımcı olacağız.";
      break;
    default:
